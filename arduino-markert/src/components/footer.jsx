...
const Footer = () => {
    ...
    return (
        <div>
            <hr />
            <footer className="relative text-gray-600 body-font bg-gray-700 pt-8 pb-6">
                <div className="container mx-auto px-4">
                    <div className="flex flex-wrap text-left lg:text-left">
                        <div className="w-full lg:w-6/12 px-4">
                            <h4 className="text-3xl fonat-semibold text-blueGray-700 text-white">Siguenos en </h4>
                    ...
                    <div className="flex flex-wrap items-center md:justify-between justify-center text-white">
                        <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                            <div className="text-sm text-blueGray-500 font-semibold py-1">
                                Copyright © mikrotronica
                                <span id="get-current-year"> {date.getUTCFullYear()}</span>
