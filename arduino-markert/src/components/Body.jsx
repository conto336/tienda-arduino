                        ...
                        <main id="main" className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                            ...
                            <div className="sm:text-center lg:text-left">
                                <div className="text-center">
                                    <h2 className="text-2xl tracking-tight font-extrabold text-gray-900 sm:text-3xl md:text-3xl">
                                ...
                                <br />
                                <h5 className="text-4xl text-center tracking-tight font-extrabold text-gray-900 sm:text-3xl md:text-3xl">
                                    <span className="block text-indigo-600 xl:inline">
                                        <i className="fab fa-whatsapp mx-1 text-green-500"></i>
                                        Whatsapp
                                    </span>
                                </h5>
                                <h5 className="text-2xl text-center tracking-tight font-extrabold text-gray-900 sm:text-3xl md:text-3xl">
                                    <span className="block text-indigo-600 xl:inline">
                                        12345678-12345678
                                    </span>
                                </h5>
                            ...
                            <p className="leading-relaxed mb-5 font-bold text-gray-600">Donde estamos ubicados</p>
